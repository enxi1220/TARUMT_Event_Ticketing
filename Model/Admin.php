...
//    }
//    
    public function __construct($name = '', $username = '', $phone = '', $mail = '', $createdDate = '', $createdBy = '', $status = '', $role = '', $adminNo = '') {
    parent::__construct($name, $username, $phone, $mail, $createdDate, $createdBy, $status);
    $this->person = new Person($name, $username, $phone, $mail, $createdDate, $createdBy, $status);
//    $this->createdBy = $createdBy;
