...
<div class="p-5 rounded-2">
    <div class="row">
        <div class="col">
            <h2 class="float-start mb-5">Add Category</h2>
        </div>
    </div>
    <form id="form-add-category" class="needs-validation" novalidate  method="POST">
...
require '../../Footer.php';
?>
<script src="../../../Script/BackOffice/Category/CategoryCreate.js"></script>