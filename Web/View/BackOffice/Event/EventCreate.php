...
<div class="bg-light p-5 rounded-2">
    ...
    <form>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="VIPTicketQuantity" id="txt-vip-ticket-qty" min="0" class="form-control" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label" for="txt-std-ticket-qty">Standard Ticket Quantity*</label>
                        <input type="number" name="StandardfTicketQuantity" id="txt-std-ticket-qty" min="0" class="form-control" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label" for="txt-bgt-ticket-qty">Budget Ticket Quantity*</label>
                        <input type="number" name="BudgetTicketQuantity" id="txt-bgt-ticket-qty" min="0" class="form-control" />
                    </div>
                </div>
            </div>
        </fieldset>
        ...
        <div class="col d-flex justify-content-end mb-4">
            ...
            <button type="button" id="btn-add-event" class="btn btn-primary btn-floating ms-4" data-mdb-toggle="tooltip" title="Save">
