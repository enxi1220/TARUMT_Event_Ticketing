                            ...
                            <pre:forEach items="${payments}" var="payment">
                                <pre:forEach items="${payment.order.orderDetail}" var="orderDetail">
                                    <tr>
                                        ...
                                        <td>
                                            <pre:out value="${orderDetail.productName}" />
                                        </td>
                                        <td>
                                            <pre:out value="${orderDetail.color}" />
                                        </td>
                                        <td>
                                            <pre:out value="${orderDetail.size}" />
                                        </td>
                                        <td>
                                            <pre:out value="${orderDetail.quantity}" />
                                        </td>
                                        <td>
                                            <fmt:formatNumber value="${orderDetail.price}" type="number" minFractionDigits="2" />
                                        </td>
                                        <td>
                                            <fmt:formatNumber value="${orderDetail.price * orderDetail.quantity}" type="number" minFractionDigits="2" />
                                        </td>
                                    </tr>
                                </pre:forEach>
                            </pre:forEach>
